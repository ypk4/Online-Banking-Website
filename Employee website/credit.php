...
// 	 		$affected_rows = $conn->affected_rows;
		 ...
		 // echo "Today is " . $date . "<br>";
   		 ...
   		 $sql = "INSERT INTO Transactions(date, time, to_acc, amount, description) 
                           VALUES('$date', '$time', $account, $amount, 'Credit')"; 		/* HERE */
...
<ul id="vert_menubar">
  ...
  <li><a class = "active" href="http://miniprojectofwebsite2.000webhostapp.com/credit.php">Credit money</a></li>
...
<div id = "credit"> Credit Money</div>
<br>
...
echo '
 <div id = "back" >
    ...
    <input type="number" id="num1" name="account" value="', $account, '" required> 
<br>
<br>
...
<!--	 <div id = "back" >
    ...
    <input type="number" id="num1" name="account" value="<?php echo $account;?>" required> 
<br>
<br>
<label for="num2">Amount :</label>
